...
namespace E_Shift.Admin_Dashboard
{
    public partial class ucLoad : UserControl
    {
        ...
        private void job_Product_Loadtble_load() //load datagrid view
        {
            try
            {
                DB.openConnection(); //open sql connection
                DB.showRecords("SELECT * from job_product_load", "job_product_load"); //search records in the load table
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    //showing message box
                    MessageBox.Show("Updated Successfully", "E-Shift", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    //clear_Textbox();//invoke clear textbox method
                    //updateJob_status();
